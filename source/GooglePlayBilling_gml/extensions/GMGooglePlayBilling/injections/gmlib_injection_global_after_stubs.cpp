...
void Init_GMGooglePlayBilling()
{
    ...
    libHandle = ExtUtils_GetLibraryHandle("GMGooglePlayBilling.ext");
    if (libHandle)
    {
...
void Startup_GMGooglePlayBilling()
{
...
void Shutdown_GMGooglePlayBilling()
{
    if (!isInitialized) return;
